...
## Homework 7
 - В рамках седьмого ДЗ были подготовлены SQL запросы для соссталения списка пользователей users, которые осуществили хотя бы один заказ orders в интернет магазине, для вывода списка товаров products и разделов catalogs, который соответствует товару, а также для вывода списка полетов с русскими названиям городов
 - Необходимые таблицы были созданы и заполнены
 - Файл для седьмого ДЗ - **tasks_1_2_3.sql** - выложен в папке **topic7** 
